...
MODEL_FILTER_COL = "Kurtosis"
MODEL_FILTER_THRESHOLD = -0.841103
...
def main() -> None:
    ...
    output_1pt = OUTPUT_DIR / "model_0522_1pt_1d_filtered.csv"
    output_2pt = OUTPUT_DIR / "model_0522_2pt_1d_filtered.csv"

    model_1pt.to_csv(output_1pt, index=False, encoding="utf-8-sig")
    model_2pt.to_csv(output_2pt, index=False, encoding="utf-8-sig")

    print(f"1pt rows: {len(model_1pt)}")
    print(f"2pt rows: {len(model_2pt)}")
